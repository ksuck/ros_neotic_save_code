...
from rip_edu_msgs.msg import DetectedObject, DetectedObjectArray
...
class HumanPoseDetectionService:
   def __init__(self):
      ...
      self.service = rospy.Service('/rip/turtlebot/vision/human_pose_detection', HumanPoseDetection, self.run)
      detector_type = rospy.get_param('~detector_type', 'tf2')
      frozen_graph = rospy.get_param('~inference_graph', '')
      saved_model_path = rospy.get_param('~saved_model', '/home/naja/Home/src/rip_edu_vision/data/resnet50_model/saved_model')
      label_map = rospy.get_param('~label_map', '/home/naja/Home/src/rip_edu_vision/data/tensorflow_model/pet_label_map.pbtxt')
      ...
      rospy.loginfo("HumanPoseDetection Service started!")
   ...
   def run(self, req):
      # run while ROS runs
      res = HumanPoseDetectionResponse()
               ...
               for obj_class in objects:
                  ...
                  for obj_type_index, coordinates in enumerate(objects[obj_class]):
                     ...
                     if publish_tf:
                        ...
                        print("point_z = "+str(point_z) +" point_x = "+str(point_x) +" point_y = "+str(point_y))
                        frame = 'camera_link'
