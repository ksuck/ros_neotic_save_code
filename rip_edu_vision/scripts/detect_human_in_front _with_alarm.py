...
from rip_edu_msgs.srv import DetectHumanInFront, DetectHumanInFrontResponse, TextToSpeech
import cv2
                    ...
                    if results[0].boxes.id is not None:
                        ...
                        for box , id  in zip(boxes,track_ids):
                            ...
                            if 0 < px1 < w and 0 < py1 < h:  # Check bounds for px1 and py1
                                ...
                                if dist < 0.1:
                                    self.sucess = True
                                    self.call_text_to_speech("thank you")
                                ...
                                os.system('play -n synth 0.2 sin 800')
                                self.call_text_to_speech("Someone in this house get injured please help")
